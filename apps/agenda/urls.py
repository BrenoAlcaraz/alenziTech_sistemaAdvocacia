...
urlpatterns = [
    ...
    path("agenda/disponibilidade/", views.disponibilidade_convidado, name="disponibilidade_convidado"),
    path("agenda/novo/", views.novo, name="novo"),
    path("agenda/convites/<int:pk>/responder/", views.convite_responder, name="convite_responder"),
    path("agenda/<int:pk>/editar/", views.editar, name="editar"),
    path("agenda/<int:pk>/concluir/", views.concluir, name="concluir"),
    path("agenda/<int:pk>/iniciar/", views.iniciar, name="iniciar"),
    path("agenda/<int:pk>/reatribuir/", views.reatribuir, name="reatribuir"),
