...
class TenantWebsocketMiddleware:
    ...
    conexão. Fecha a conexão se não houver tenant para o domínio ou se o
    usuário não estiver autenticado — mesma política de `@login_required`
    já aplicada em toda view do sistema."""
