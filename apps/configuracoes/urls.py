...
urlpatterns = [
    ...
    path("configuracoes/perfil/foto/", views.foto_perfil, name="foto_perfil"),
    path("configuracoes/usuarios/<int:user_pk>/foto/", views.foto_usuario, name="foto_usuario"),
    ...
    path("configuracoes/identidade-visual/", views.identidade_visual, name="identidade_visual"),
    path("configuracoes/usuarios/<int:user_pk>/excluir/", views.excluir_usuario, name="excluir_usuario"),
