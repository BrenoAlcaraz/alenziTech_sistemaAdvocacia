...
consequências. Um PDR não descreve o estado atual do código — isso é
responsabilidade de [STATUS.md](../STATUS.md) e das seções de módulo em
[PRODUCT.md](../PRODUCT.md)/[modules/](../modules/).
...
Decisões que ainda não foram aprovadas não são PDRs — ficam em
[STATUS.md#decisões-em-aberto](../STATUS.md#decisões-em-aberto) até
serem efetivamente decididas.
...
| PDR-0029 | Financeiro líquido de custas do cliente e honorário sucumbencial calculado | accepted; item 4 ajustado por PDR-0032 | [PDR-0029-financeiro-liquido-de-custas-e-honorario-calculado.md](PDR-0029-financeiro-liquido-de-custas-e-honorario-calculado.md) |
