...
[docs/delivery/roadmap.md#fase-a--consolidar-autorização-nas-operações](../../delivery/roadmap.md#fase-a--consolidar-autorização-nas-operações)
e
[docs/security/authorization-matrix.md#processos](../../security/authorization-matrix.md#processos)
...
- [docs/product/modules/processos.md](../modules/processos.md),
  [docs/security/authorization-matrix.md](../../security/authorization-matrix.md)
  e a leitura de Fase A do roadmap para Processos passam a refletir
...
que classificava a ausência de checagem de
...
consolidando e resolvendo a ambiguidade entre
[docs/delivery/roadmap.md#fase-a--consolidar-autorização-nas-operações](../../delivery/roadmap.md#fase-a--consolidar-autorização-nas-operações)
e
[docs/security/authorization-matrix.md#processos](../../security/authorization-matrix.md#processos)
para o módulo Processos.
